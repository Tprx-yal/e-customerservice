...
class Settings(BaseSettings):
    ...
    # 数据库配置
    DB_ENGINE: str = "mysql"  # 默认使用PostgreSQL
    DB_HOST: str = "localhost"
    DB_PORT: int | None = Field(default=3306, validate_default=True)
    ...
    DB_NAME: str = "customerservice_db"
    ...
    SWAGGER_UI_PASSWORD: str = os.getenv("SWAGGER_UI_PASSWORD", "your_password")
    ...
    def _validate_production_config(self):
        ...
        if self.DB_ENGINE == "sqlite":
            raise ValueError("生产环境建议使用mySQL而非SQLite")
